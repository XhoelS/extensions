...
function Navbar({ filter, setFilter }) {
  ...
  return (
    <>
      <div className="sticky top-0 bg-[#0b0d10] z-1 py-4">
        <div className="bg-[#161b22]  text-amber-50 flex items-center gap-1.5 p-3 text-xl rounded-2xl m-8 max-[600px]:flex max-[600px]:justify-center max-[600px]:py-2.5 max-[600px]:text-2xl ">
          <h1>Extensions</h1>
        </div>
